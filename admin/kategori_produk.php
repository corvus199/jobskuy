<?php 
	...
	if(!empty($_GET)){
		if($_GET['act'] == 'delete'){
			...
			if($q){ alert("Menghapus Kategori Produk Berhasil !"); redir("kategori_produk.php"); }
		}  
	}
	if(!empty($_GET['act']) && $_GET['act'] == 'create'){
		if(!empty($_POST)){
			...
			if($q){ alert("Menambah Kategori Produk Berhasil !"); redir("kategori_produk.php"); }
		}
	}
	if(!empty($_GET['act']) && $_GET['act'] == 'edit'){
		if(!empty($_POST)){
			...
			if($q){ alert("Mengedit Kategori Produk Berhasil !"); redir("kategori_produk.php"); }
		}
	}
